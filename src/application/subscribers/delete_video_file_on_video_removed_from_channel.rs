...
mod tests {
    ...
    fn it_should_schedule_a_delete_video_file_task_when_the_video_was_downloaded() {
        ...
        subscriber
            .handle(
                r#"{"channel_id": "@somechannel", "video_id": "rec1", "title": "My Video", "filename": "My Video.mp4", "was_downloaded": true}"#,
            )
            .unwrap();
    ...
    fn it_should_not_schedule_a_task_when_the_video_was_not_downloaded() {
        ...
        subscriber
            .handle(
                r#"{"channel_id": "@somechannel", "video_id": "rec1", "title": "My Video", "filename": null, "was_downloaded": false}"#,
            )
            .unwrap();
    ...
    fn it_should_no_op_when_the_payload_channel_id_is_invalid() {
        ...
        subscriber
            .handle(
                r#"{"channel_id": "", "video_id": "rec1", "title": "My Video", "filename": null, "was_downloaded": true}"#,
            )
            .unwrap();
    ...
    fn it_should_no_op_when_the_channel_no_longer_exists() {
        ...
        subscriber
            .handle(
                r#"{"channel_id": "@missing", "video_id": "rec1", "title": "My Video", "filename": "My Video.mp4", "was_downloaded": true}"#,
            )
            .unwrap();
